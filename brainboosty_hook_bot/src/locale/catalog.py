...
RU: dict[str, str] = {
    ...
    "QUESTION_SKILL": "🎯 Шаг 2/4. Что хочешь прокачать в первую очередь?",
    "QUESTION_AGE": "🎂 Шаг 3/4. Сколько полных лет? Числом (например, 24).",
    "QUESTION_TIME": "⏱ Шаг 4/4. Сколько минут в день готов уделять?",
    ...
    "GOAL_REC_memory": "💡 Фокус: память — интервальные напоминания вместо зубрёжки подряд.",
    ...
    "GOAL_REC_empathy": "💡 Фокус: эмпатия — отражение чувствами своими словами, без советов.",
...
EN: dict[str, str] = {
    ...
    "QUESTION_SKILL": "🎯 Step 2/4. What do you want to train first?",
    "QUESTION_AGE": "🎂 Step 3/4. Your age in full years (e.g. 24).",
    "QUESTION_TIME": "⏱ Step 4/4. Minutes per day you can spend?",
    ...
    "GOAL_REC_memory": "💡 Focus: memory — spaced retrieval instead of cramming.",
    ...
    "GOAL_REC_empathy": "💡 Focus: empathy — reflect feelings in your own words, no advice yet.",
