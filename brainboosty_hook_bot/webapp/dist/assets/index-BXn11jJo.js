...
<section class="bb-section bb-cover" data-section="cover">
  ...
  `)}function Oe(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function I(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function je(e,t,a){const n=e.regions[t]??t,r=$e[t],s=Number(a.main??0),i=e.progressMain(`${s.toFixed(1)}`),o=[Z({label:e.zoneLevel,value:s,glow:!0}),...(a.submetrics??[]).map(l=>Z({label:l.label,value:l.value,glow:!1}))].join(`
`),b=(a.bullets??[]).map(l=>`<li>${I(l)}</li>`).join(`
        `);return`
...
</section>`}function Ue(e,t,a){const n=z(t.lang),r=t.userDisplayName||(t.lang==="en"?"Guest":"Гость"),s=[De(n,{displayName:r,neuroScore:t.neuroScore,connectivity:t.connectivity}),...B.map(i=>{var o,b;return je(n,i,{main:t.scores[i],bullets:((o=t.regions[i])==null?void 0:o.bullets)??[],submetrics:((b=t.regions[i])==null?void 0:b.submetrics)??[]})})];e.innerHTML=s.join(`
`),Ge(e),Ve(e),Ye(e),We(e,t,a)}function We(e,t,a){var o,b;const n=e.querySelectorAll("[data-open-zone]");if(!n.length)return;const r=l=>{e.querySelectorAll(".bb-region").forEach(w=>{const c=w.dataset.region;w.classList.toggle("is-zone-hot",!!l&&c===l)})},s=l=>{!l||!B.includes(l)||(r(l),Re(t,l,{onClose:()=>r(null)}))};n.forEach(l=>{l.addEventListener("pointerenter",()=>r(l.getAttribute("data-open-zone")||"")),l.addEventListener("pointerleave",w=>{const c=w.relatedTarget;c instanceof Node&&e.contains(c)&&c.closest("[data-open-zone]")||r(null)}),l.addEventListener("click",w=>{w.preventDefault();const c=l.getAttribute("data-open-zone");c&&(T(),s(c))})});const i=(b=(o=a==null?void 0:a.params)==null?void 0:o.get)==null?void 0:b.call(o,"zone");i&&B.includes(i)&&requestAnimationFrame(()=>s(i))}function Ge(e){const t=e.querySelectorAll(".bb-section"),a=new IntersectionObserver(n=>{for(const r of n)r.isIntersecting&&(r.target.classList.add("is-visible"),a.unobserve(r.target))},{root:null,rootMargin:"0px 0px -8% 0px",threshold:.08});t.forEach(n=>a.observe(n))}function Ve(e){const t=e.querySelector("[data-neuro-score]");if(!t)return;const a=parseFloat(t.textContent||"0"),n=1200,r=performance.now(),s=i=>{const o=Math.min(1,(i-r)/n),b=1-(1-o)**3;t.textContent=(a*b).toFixed(1),o<1&&requestAnimationFrame(s)};requestAnimationFrame(s)}function Ye(e){const t=e.querySelectorAll("[data-bar-value]"),a=new IntersectionObserver(n=>{for(const r of n){if(!r.isIntersecting)continue;const s=r.target,i=parseFloat(s.getAttribute("data-bar-value")||"0"),o=s.querySelector(".pdf-bar-gradient");o&&(o.style.clipPath="inset(0 100% 0 0)",requestAnimationFrame(()=>{o.style.clipPath=`inset(0 ${Math.max(0,100-i).toFixed(2)}% 0 0)`})),a.unobserve(s)}},{threshold:.2});t.forEach(n=>a.observe(n))}function m(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Xe(){return{instruction:'<svg class="ex-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" aria-hidden="true"><path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/></svg>',research:'<svg class="ex-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" aria-hidden="true"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3M11 8v6M8 11h6"/></svg>',amplify:'<svg class="ex-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" aria-hidden="true"><path d="M12 3l1.8 5.5h5.7l-4.6 3.4 1.8 5.5-4.7-3.4-4.7 3.4 1.8-5.5-4.6-3.4h5.7L12 3z"/></svg>',results:'<svg class="ex-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" aria-hidden="true"><path d="M4 19V5M9 19v-6M14 19V9M19 19v-9"/><path d="M4 19h16" stroke-linecap="round"/></svg>'}}function G(e){return String(e||"").split(`
`).map(a=>`<p>${m(a)}</p>`).join("")}function Ze(e){e.querySelectorAll(".ex-acc").forEach(t=>{const a=t.querySelector(".ex-acc__trigger");a&&a.addEventListener("click",()=>{const r=!(t.getAttribute("data-open")==="true");t.setAttribute("data-open",String(r)),a.setAttribute("aria-expanded",String(r)),T()})})}function R(e){requestAnimationFrame(()=>{var t;(t=e.querySelector(".ex-lux"))==null||t.classList.add("is-visible")})}async function Je(e,t,a,n){var h,E;const r=z(a.lang),s=Xe();e.className="bb-root bb-root--spa bb-root--exercise",e.innerHTML=`
    <div class="ex-lux">
    ...
    </div>`;const i=e.querySelector("#ex-back");if(i==null||i.addEventListener("click",()=>{T(),C("map")}),!Number.isFinite(n)||n<1){const d=e.querySelector(".ex-lux__scroll .ex-lux__inner");d&&(d.innerHTML=`<p class="ex-lux__err">${m(r.exerciseNotFound)}</p>`),R(e);return}if(!a.paid){e.querySelector(".ex-lux__scroll .ex-lux__inner").innerHTML=`
      ...
      </div>`,(h=e.querySelector("#ex-unlock"))==null||h.addEventListener("click",()=>{T(),a.tributeUrl?O(a.tributeUrl):C("premium")}),e.querySelector("#ex-cta").textContent=r.premiumCta,(E=e.querySelector("#ex-cta"))==null||E.addEventListener("click",()=>{T(),a.tributeUrl?O(a.tributeUrl):C("premium")}),R(e);return}let o;try{o=await Me(t,n)}catch(d){const x=e.querySelector(".ex-lux__scroll .ex-lux__inner"),u=(d==null?void 0:d.status)===403?r.exercisePremiumTitle:(d==null?void 0:d.status)===404?r.exerciseNotFound:r.errorLoad;x&&(x.innerHTML=`<p class="ex-lux__err">${m(u)}</p>`),R(e);return}const b=Math.max(0,Math.min(4,(o.effectiveness||3)-1)),l=r.exerciseEfficiencyLabels[b]??"—",w=(o.regions||[]).map(d=>`<span class="ex-lux__pill">${m(r.regions[d]??d)}</span>`).join(""),c=(o.researchLinks||[]).map(d=>`<a class="ex-lux__link" href="${m(d.url)}" target="_blank" rel="noopener noreferrer">${m(d.label||d.url)}</a>`).join(""),f=o.instructionImageUrl?`<figure class="ex-lux__figure"><img src="${m(o.instructionImageUrl)}" alt="" loading="lazy" decoding="async" /></figure>`:"";e.querySelector(".ex-lux__scroll .ex-lux__inner").innerHTML=`
    <div class="ex-lux__hero">
    ...
    <div class="ex-lux__scroll-pad"></div>`,Ze(e);const g=e.querySelector("#ex-cta");g==null||g.addEventListener("click",()=>{var d,x,u;T(),(u=(x=(d=window.Telegram)==null?void 0:d.WebApp)==null?void 0:x.showAlert)==null||u.call(x,r.exerciseCtaMessage)}),R(e)}function D(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Qe(e,t){if(!e)return"—";try{return new Date(e).toLocaleString(t==="en"?"en-GB":"ru-RU",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return e}}async function Ke(e,t,a){var l,w;const n=z(a.lang),r=Y().params.get("zone"),s=document.createElement("section");s.className="bb-section is-visible bb-history",s.innerHTML=`
  ...
  `;const i=document.createElement("div");i.className="space-y-3",i.textContent=n.loading,s.appendChild(i),e.replaceChildren(s);let o;try{o=await ze(t)}catch{i.innerHTML=`<p class="bb-error">${D(n.errorLoad)}</p>`;return}const b=o.items??[];if(i.replaceChildren(),!b.length){const c=document.createElement("div");c.className="glass rounded-2xl p-5 text-center";const f=document.createElement("p");f.className="text-slate-200 mb-4",f.textContent=n.historyEmpty;const g=document.createElement("button");g.type="button",g.className="bb-btn-primary",g.textContent=n.startTest,g.addEventListener("click",()=>C("test")),c.append(f,g),i.appendChild(c);return}for(const[c,f]of b.entries()){const g=document.createElement("article");g.className=`glass rounded-2xl p-4 bb-history-card${c===0?" is-active":""}`;const h=document.createElement("div");h.className="flex justify-between items-start gap-2 mb-2";const E=document.createElement("div");if(E.innerHTML=`
      <p class="text-xs text-cyan-200/80 uppercase tracking-wide">${D(Qe(f.createdAt,a.lang))}</p>
    ...
    `,h.appendChild(E),c===0){const u=document.createElement("span");u.className="bb-badge",u.textContent=n.latest,h.appendChild(u)}g.appendChild(h);const d=document.createElement("div");d.className="bb-history-deltas";for(const u of B){const L=n.regions[u]??u,v=Number(((l=f.scores)==null?void 0:l[u])??0).toFixed(1),k=f.isFirst?"—":((w=f.deltas)==null?void 0:w[u])??"·",p=document.createElement("div");p.className=`bb-history-row${r===u?" bb-history-row--focus":""}`;const N=document.createElement("span");N.textContent=L;const M=document.createElement("span");M.textContent=`${v}%`;const q=document.createElement("span");q.textContent=k,typeof k=="string"&&k.includes("↑")&&(q.className="bb-delta-up"),typeof k=="string"&&k.includes("↓")&&(q.className="bb-delta-down"),p.append(N,M,q),d.appendChild(p)}g.appendChild(d);const x=document.createElement("button");x.type="button",x.className="bb-btn-ghost mt-3 w-full",x.textContent=n.openThisMap,x.addEventListener("click",()=>C("map")),g.appendChild(x),i.appendChild(g)}r&&b.length&&requestAnimationFrame(()=>{var c;(c=s.querySelector(".bb-history-row--focus"))==null||c.scrollIntoView({block:"center",behavior:"smooth"})})}function F(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function et(e,t){var n;const a=z(t.lang);e.innerHTML=`
  ...
  `,(n=e.querySelector("#bb-premium-buy"))==null||n.addEventListener("click",()=>{T(),t.tributeUrl&&O(t.tributeUrl)})}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}async function tt(e,t,a,{onProfile:n}={}){const r=z(a.lang),s={variant:a.testVariant||"development",questions:[],answers:{},step:0},i=document.createElement("section");i.className="bb-section is-visible bb-test",e.replaceChildren(i);async function o(){i.innerHTML=`<p class="text-cyan-200/80 text-sm">${S(r.loading)}</p>`;try{const c=await Ce(t,s.variant);s.questions=c.questions??[],s.step=0,s.answers={},l()}catch{i.innerHTML=`<p class="bb-error">${S(r.errorLoad)}</p>`}}function b(){i.innerHTML=`
    ...
    `,i.querySelectorAll("[data-variant]").forEach(c=>{c.addEventListener("click",()=>{T(),s.variant=c.getAttribute("data-variant")||"development",o()})})}function l(){const c=s.questions[s.step];if(!c){b();return}const f=s.questions.length,g=(s.step+1)/f*100;i.innerHTML=`
    ...
    `;const h=i.querySelector("#bb-test-options");for(const E of c.options??[]){const d=document.createElement("button");d.type="button",d.className="bb-test-option",d.innerHTML=`<span class="bb-test-option-key">${S(E.key)}</span><span>${S(E.label)}</span>`,d.addEventListener("click",()=>w(E.key)),h.appendChild(d)}}async function w(c){T();const f=s.questions[s.step];if(s.answers[f.id]=c,s.step+1<s.questions.length){s.step+=1,l();return}i.innerHTML=`
      <div class="bb-loading">
        <div class="bb-loading__pulse"></div>
        <p class="text-sm text-cyan-200/80">${S(r.computing)}</p>
      </div>`;try{const g={};for(const[E,d]of Object.entries(s.answers))g[String(E)]=d;const h=await Ne(t,{variant:s.variant,answers:g});n&&n(h),C("map")}catch{i.innerHTML=`<p class="bb-error">${S(r.errorLoad)}</p>`}}b()}let _=null,A=null;function nt(e){var s;document.body.classList.add("bb-app--needs-bot"),(s=document.querySelector(".bb-premium-fab"))==null||s.remove();const t=document.getElementById("bb-nav");t&&(t.hidden=!0,t.innerHTML="");const a=z(_.lang);e.className="bb-root bb-root--spa bb-root--bot-gate",e.replaceChildren();const n=document.createElement("div");n.className="bb-bot-gate",n.setAttribute("role","status");const r=document.createElement("p");r.className="bb-bot-gate__line",r.textContent=a.notRegistered,n.appendChild(r),e.appendChild(n)}async function at(e){var a;if(A)return document.body.classList.remove("bb-app--needs-bot"),!0;const t=z(_.lang);e.className="bb-root bb-root--spa",e.innerHTML=`
      <div class="bb-loading">
        <div class="bb-loading__pulse"></div>
        <p class="text-sm text-cyan-200/80">${t.loading}</p>
      </div>`;try{return A=await Ae(_),document.body.classList.remove("bb-app--needs-bot"),le(A),(a=_.user)!=null&&a.first_name&&!A.userDisplayName&&(A.userDisplayName=[_.user.first_name,_.user.last_name].filter(Boolean).join(" ")),!0}catch(n){if((n==null?void 0:n.status)===401&&(n==null?void 0:n.detail)==="invalid_site_token"&&(_!=null&&_.siteToken)){try{localStorage.removeItem(U),localStorage.removeItem(W)}catch{}return window.location.replace("/"),!1}if((n==null?void 0:n.status)===403&&(n==null?void 0:n.detail)==="not_registered")return nt(e),!1;const r=(n==null?void 0:n.status)===403?t.notRegistered:(n==null?void 0:n.status)===401?t.authError:t.errorLoad;return e.className="bb-root bb-root--spa",e.innerHTML=`<p class="bb-error">${r}</p>`,!1}}function rt(e){const t=document.getElementById("bb-nav");t&&t.querySelectorAll(".bb-nav__btn[data-route]").forEach(a=>{a.classList.toggle("is-active",a.dataset.route===e)})}function st(e){if(!_)return;const t=e==="en"?"en":"ru";if(_.lang===t)return;_.lang=t,document.documentElement.lang=t;const a=z(t),n=document.getElementById("bb-header-wordmark");n&&(n.textContent=a.appBrandName),ce(t)}function le(e){e!=null&&e.lang&&st(e.lang)}function it(e){var n;if((n=document.querySelector(".bb-premium-fab"))==null||n.remove(),e.paid||!e.tributeUrl)return;const t=z((_==null?void 0:_.lang)||e.lang),a=document.createElement("button");a.type="button",a.className="bb-premium-fab",a.textContent=t.premiumCta,a.addEventListener("click",()=>{T(),C("premium")}),document.body.appendChild(a)}function ce(e){var r;const t=document.getElementById("bb-nav");if(!t)return;const a=z(e);t.hidden=!1;const n=_!=null&&_.siteToken?`<button type="button" class="bb-nav__btn bb-nav__btn--logout" data-site-logout>${a.navLogout}</button>`:"";t.innerHTML=`
    ...
    ${n}
  `,t.querySelectorAll(".bb-nav__btn[data-route]").forEach(s=>{s.addEventListener("click",()=>{T(),C(s.dataset.route||"map")})}),(r=t.querySelector("[data-site-logout]"))==null||r.addEventListener("click",()=>{T();try{localStorage.removeItem(U),localStorage.removeItem(W)}catch{}window.location.replace("/")})}async function J(e){var r;const t=document.getElementById("bb-root");if(!t||!_)return;const a=document.getElementById("bb-nav"),n=e.name==="exercise";if(document.body.classList.toggle("bb-route-exercise",n),n||rt(e.name),e.name!=="map"&&((r=document.querySelector(".bb-premium-fab"))==null||r.remove()),!!await at(t)){if(ce(_.lang),a&&(a.hidden=n),e.name==="premium"){et(t,A);return}if(e.name==="test"){await tt(t,_,A,{onProfile:s=>{A=s,le(s)}});return}if(e.name==="history"){await Ke(t,_,A);return}if(e.name==="exercise"){const s=parseInt(e.params.get("id")||"0",10);await Je(t,_,A,s);return}if(!A.hasMap&&e.name==="map"){C("test");return}Ue(t,A,e),it(A)}}async function Q(e){const t=e.lang==="en"?"en":"ru";_={initData:e.initData??"",user:e.user??null,lang:t,siteToken:e.siteToken??""},A=null,document.body.classList.add("bb-app--telegram"),_.siteToken&&document.body.classList.add("bb-app--site");const a=document.getElementById("bb-root");if(!a)return;a.classList.add("bb-root--spa");const n=z(_.lang),r=document.getElementById("bb-header-wordmark");r&&(r.textContent=n.appBrandName),qe(i=>{J(i).catch(()=>{})}),Ie();const s=Y();window.location.hash?await J(s):C("map")}const K="/assets/full-glowing-brain-Cl127Rfm.png",ee=.088,te=15,ne=2,ae=.4;function j(e,t,a){return Math.max(t,Math.min(a,e))}function ot(){var e,t;return((t=(e=window.matchMedia)==null?void 0:e.call(window,"(prefers-reduced-motion: reduce)"))==null?void 0:t.matches)??!1}function lt(e,t,a){const n=e.getBoundingClientRect(),r=80,s=Math.max(n.width+r*2,1),i=Math.max(n.height+r*2,1),o=n.left+n.width/2,b=n.top+n.height/2;return{nx:j((t-o)/(s*.5),-1,1),ny:j((a-b)/(i*.5),-1,1)}}function ct(e){var u,L;if(ot())return()=>{};const t=e.querySelector("[data-parallax-brain]"),a=e.querySelector("[data-parallax-glow]");if(!t)return()=>{};let n={nx:0,ny:0},r=!1,s={nx:0,ny:0},i=!1,o=0,b=0,l=0;const w=((L=(u=window.matchMedia)==null?void 0:u.call(window,"(pointer: coarse)"))==null?void 0:L.matches)??!1,c=()=>r?{tx:n.nx,ty:n.ny}:i?{tx:s.nx*.62,ty:s.ny*.62}:{tx:0,ty:0},f=()=>{l=0;const{tx:v,ty:k}=c();o+=(v-o)*ee,b+=(k-b)*ee;const p=o*te,N=b*te,M=b*-ne,q=o*ne;if(t.style.transform=`translate3d(${p}px, ${N}px, 0) rotateX(${M}deg) rotateY(${q}deg)`,a){const me=-p*ae,he=-N*ae;a.style.transform=`translate3d(calc(-50% + ${me}px), calc(-50% + ${he}px), 0) scale(1.06)`}const{tx:ue,ty:be}=c(),pe=Math.abs(o-ue)>.003||Math.abs(b-be)>.003,ge=Math.abs(o)>.004||Math.abs(b)>.004;(pe||ge||i)&&(l=requestAnimationFrame(f))},g=()=>{l||(l=requestAnimationFrame(f))},h=v=>{if(!v.isTrusted)return;const{nx:k,ny:p}=lt(e,v.clientX,v.clientY);n={nx:k,ny:p},r=!0,g()},E=()=>{r=!0},d=()=>{r=!1,g()};e.addEventListener("pointermove",h,{passive:!0}),e.addEventListener("pointerenter",E),e.addEventListener("pointerleave",d),e.addEventListener("pointerdown",()=>{w&&typeof(DeviceOrientationEvent==null?void 0:DeviceOrientationEvent.requestPermission)=="function"&&DeviceOrientationEvent.requestPermission().then(v=>{v==="granted"&&(i=!0)}).catch(()=>{})},{passive:!0});let x=null;return window.DeviceOrientationEvent&&(x=v=>{if(v.gamma==null||v.beta==null)return;const k=j(v.gamma/32,-1,1),p=j((v.beta-44)/36,-1,1);s={nx:k,ny:p},i=!0,g()},window.addEventListener("deviceorientation",x,!0)),t.style.willChange="transform",a&&(a.style.willChange="transform"),g(),()=>{e.removeEventListener("pointermove",h),e.removeEventListener("pointerenter",E),e.removeEventListener("pointerleave",d),x&&window.removeEventListener("deviceorientation",x,!0),l&&cancelAnimationFrame(l),t.style.willChange="",t.style.transform="",a&&(a.style.willChange="",a.style.transform="")}}const dt={root:null,rootMargin:"0px 0px -10% 0px",threshold:.08};function ut(e,{reducedMotion:t}){if(t)return e.querySelectorAll(".bb-landing-reveal").forEach(r=>r.classList.add("is-in-view")),()=>{};const a=e.querySelectorAll(".bb-landing-reveal");if(!a.length)return()=>{};const n=new IntersectionObserver(r=>{for(const s of r)s.isIntersecting&&(s.target.classList.add("is-in-view"),n.unobserve(s.target))},dt);return a.forEach(r=>n.observe(r)),()=>{n.disconnect()}}function y(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const de="bb-landing-lang",bt={not_registered:"landingHubErrorNotRegistered",oidc_not_configured:"landingHubErrorNotConfigured",token_exchange_failed:"landingHubErrorOidc",invalid_state:"landingHubErrorOidc",state_expired:"landingHubErrorOidc",missing_code:"landingHubErrorOidc"};function pt(){try{const e=localStorage.getItem(de);if(e==="en"||e==="ru")return e}catch{}return null}function gt(e,t){const a=bt[t];return a&&e[a]?e[a]:e.landingHubErrorOidc}function mt(){const e=(window.location.hash||"").replace(/^#/,"");if(!e.startsWith("hub-login"))return null;const t=e.includes("?")?e.slice(e.indexOf("?")+1):"";return new URLSearchParams(t).get("error")}function ht(e){document.body.classList.add("bb-lang-gate-open");const t=document.createElement("div");t.className="bb-lang-gate",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-labelledby","bb-lang-gate-title"),t.innerHTML=`
  ...
  `,document.body.appendChild(t);const a=n=>{try{localStorage.setItem(de,n)}catch{}document.body.classList.remove("bb-lang-gate-open"),t.remove(),e(n)};t.querySelectorAll("[data-lang]").forEach(n=>{n.addEventListener("click",()=>a(n.getAttribute("data-lang")||"ru"))}),requestAnimationFrame(()=>{var n;(n=t.querySelector(".bb-lang-gate__btn"))==null||n.focus()})}async function ft(){const e=document.getElementById("bb-header"),t=document.getElementById("bb-nav");e&&(e.hidden=!0),t&&(t.hidden=!0);const a=document.getElementById("bb-root");if(!a)return;const n=pt();if(!n){a.className="bb-root",a.innerHTML="",ht(r=>{re(r).catch(()=>{})});return}await re(n)}async function re(e){var x;const t=z(e);document.documentElement.lang=e;const a=document.getElementById("bb-root");if(!a)return;a.className="bb-root bb-root--landing",a.innerHTML=`
    ...
    <div class="bb-landing">
      <header id="top" class="bb-landing-hero">
        ...
        <p class="bb-landing-kicker">${y(t.landingKicker)}</p>
        <h1 class="bb-landing-title neon-zone-title">${y(t.landingTitle)}</h1>
        <p class="bb-landing-tagline">${y(t.landingTagline)}</p>
        <div class="bb-landing-hero__ctas">
          <a class="bb-landing-cta-primary" href="${y(n.botUrl)}" rel="noopener noreferrer">
            ${y(t.landingCta)}
          </a>
          <button type="button" class="bb-landing-cta-secondary" data-start-site-login>
            ${y(t.landingLoginTelegram)}
          </button>
        </div>
        <p class="bb-landing-cta-sub">${y(t.landingCtaSub)}</p>
        </div>
      </header>

      <section id="about" class="bb-landing-section bb-landing-reveal">
        <h2 class="bb-landing-section__title">${y(t.landingAboutTitle)}</h2>
        <article class="bb-landing-about glass bb-landing-hover-rise">
          ...
          <div class="bb-landing-about__text">
            ${t.landingAboutParagraphs.map(u=>`<p>${y(u)}</p>`).join("")}
            <a class="bb-landing-link" href="${y(n.channelUrl)}" target="_blank" rel="noopener noreferrer">
              ${y(t.landingChannelLink)}
            </a>
          </div>
        </article>
      </section>
      ...
      <section id="project" class="bb-landing-section bb-landing-reveal">
        <h2 class="bb-landing-section__title">${y(t.landingProjectTitle)}</h2>
        <ul class="bb-landing-features">${s}</ul>
        <p class="bb-landing-disclaimer">${y(t.footer)}</p>
      </section>

      <section id="hub-login" class="bb-landing-section bb-landing-hub bb-landing-reveal">
        <p class="bb-landing-hub__domain" translate="no">${y(n.hubHostDisplay)}</p>
        <h2 class="bb-landing-section__title bb-landing-hub__title">${y(t.landingHubTitle)}</h2>
        <p class="bb-landing-hub__lead">${y(t.landingHubLead)}</p>
        <p class="bb-landing-hub__hint">${y(t.landingHubHint)}</p>
        <div class="bb-landing-hub__card glass bb-landing-hover-rise">
          <button type="button" class="bb-landing-hub__start" data-start-site-login>${y(t.landingHubStartLogin)}</button>
      ...
      <section id="start" class="bb-landing-section bb-landing-final bb-landing-reveal">
        <div class="glass bb-landing-final__card bb-landing-hover-rise">
          <h2 class="bb-landing-final__title">${y(t.landingFinalTitle)}</h2>
          <p class="bb-landing-final__sub">${y(t.landingFinalSub)}</p>
          <a class="bb-landing-cta-primary bb-landing-cta-primary--lg" href="${y(n.botUrl)}" rel="noopener noreferrer">
            ${y(t.landingCta)}
          </a>
        </div>
      </section>
  ...
  `,a.querySelectorAll(".bb-landing-about__photo").forEach(u=>{const L=u.getAttribute("data-fallback-src");L&&u.addEventListener("error",()=>{u.removeAttribute("data-fallback-src"),u.src=L})}),a.querySelectorAll('a[href^="#"]').forEach(u=>{u.addEventListener("click",L=>{var p;const v=(p=u.getAttribute("href"))==null?void 0:p.slice(1);if(!v)return;const k=document.getElementById(v);k&&(L.preventDefault(),k.scrollIntoView({behavior:"smooth",block:"start"}))})});const b=a.querySelector(".bb-landing"),l=ut(b||a,{reducedMotion:i}),w=a.querySelector(".bb-landing-hero"),c=w?ct(w):()=>{},f=()=>{l(),c(),window.removeEventListener("pagehide",f)};window.addEventListener("pagehide",f);const g=a.querySelectorAll("[data-start-site-login]"),h=a.querySelector(".bb-landing-hub__status"),E=u=>{if(!h||(h.hidden=!u,h.replaceChildren(),!u))return;const L=document.createElement("p");L.className="bb-landing-hub__status-line",L.textContent=u,h.appendChild(L)};g.forEach(u=>{u.addEventListener("click",()=>{var v;const L=z(e);if((v=document.getElementById("hub-login"))==null||v.scrollIntoView({behavior:"smooth",block:"start"}),!n.oidcConfigured){E(L.landingHubErrorNotConfigured);return}window.location.href=o})});const d=mt();d&&((x=document.getElementById("hub-login"))==null||x.scrollIntoView({behavior:"smooth",block:"start"}),E(gt(t,d)),window.location.hash="hub-login")}function _t(){try{const e=navigator.userAgent||"";if(/Telegram/i.test(e))return!0;const t=`${window.location.hash||""}${window.location.search||""}`;if(/tgWebAppPlatform|tgWebAppData|tgWebAppVersion/i.test(t))return!0}catch{}return!1}function xt(){var e;return(e=window.Telegram)!=null&&e.WebApp?Promise.resolve():new Promise(t=>{const a=document.createElement("script");a.src="https://telegram.org/js/telegram-web-app.js",a.async=!0,a.onload=()=>t(),a.onerror=()=>t(),document.head.appendChild(a)})}function vt(){var a;const e=(a=window.Telegram)==null?void 0:a.WebApp;return e?(e.initData||"").trim().length>0:!1}function yt(){var e;try{return((e=localStorage.getItem(U))==null?void 0:e.trim())||""}catch{return""}}function wt(){var s;const e=(window.location.hash||"").replace(/^#/,"");if(!e.startsWith("auth/callback"))return!1;const t=e.includes("?")?e.slice(e.indexOf("?")+1):"",a=new URLSearchParams(t),n=(s=a.get("access_token"))==null?void 0:s.trim();if(!n)return!1;const r=a.get("lang")==="en"?"en":"ru";try{localStorage.setItem(U,n),localStorage.setItem(W,JSON.stringify({first_name:a.get("first_name")||"",last_name:"",language_code:r}))}catch{return!1}return window.location.replace("/#map"),!0}function Et(){try{const e=localStorage.getItem(W);return e?JSON.parse(e):null}catch{return null}}async function $t(){var n,r;if(wt())return;_t()&&await xt();const{initData:e,user:t,lang:a}=Pe();if(vt())Q({initData:e,user:t,lang:a,siteToken:""});else{const s=yt();if(s){const i=Et(),o=(i==null?void 0:i.language_code)==="en"||(r=(n=i==null?void 0:i.language_code)==null?void 0:n.startsWith)!=null&&r.call(n,"en")||a==="en"?"en":"ru";Q({initData:"",user:i?{first_name:i.first_name,last_name:i.last_name,language_code:i.language_code}:null,lang:o,siteToken:s})}else ft()}}$t().catch(()=>{});
