...
</section>`}function Z({label:e,value:t,glow:a=!1}){const n=Math.max(0,Math.min(100,Number(t)||0)),r=Math.max(0,100-n),s=a?"pdf-bar-gradient pdf-bar-gradient--main":"pdf-bar-gradient pdf-bar-gradient--sub",i=We(e);return[`<div class="mb-3.5" data-bar-value="${n}">`,'<div class="flex justify-between text-xs text-slate-400 mb-1">',`<span>${i}</span>`,`<span class="text-cyan-100 font-bold tracking-wide">${n.toFixed(1)}%</span>`,"</div>",'<div class="pdf-bar-track">',`<div class="${s}" style="clip-path: inset(0 ${r.toFixed(2)}% 0 0);"></div>`,"</div>","</div>"].join(`
  `)}function We(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function B(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ge(e,t,a){const n=e.regions[t]??t,r=ke[t],s=Number(a.main??0),i=e.progressMain(`${s.toFixed(1)}`),o=[Z({label:e.zoneLevel,value:s,glow:!0}),...(a.submetrics??[]).map(l=>Z({label:l.label,value:l.value,glow:!1}))].join(`
`),d=(a.bullets??[]).map(l=>`<li>${B(l)}</li>`).join(`
        `);return`
...
</section>`}function Ve(e,t,a){const n=C(t.lang),r=t.userDisplayName||(t.lang==="en"?"Guest":"Гость"),s=[Ue(n,{displayName:r,neuroScore:t.neuroScore,connectivity:t.connectivity}),...q.map(i=>{var o,d;return Ge(n,i,{main:t.scores[i],bullets:((o=t.regions[i])==null?void 0:o.bullets)??[],submetrics:((d=t.regions[i])==null?void 0:d.submetrics)??[]})})];e.innerHTML=s.join(`
`),Je(e),Xe(e),Ze(e),Ye(e,t,a)}function Ye(e,t,a){var o,d;const n=e.querySelectorAll("[data-open-zone]");if(!n.length)return;const r=l=>{e.querySelectorAll(".bb-region").forEach(v=>{const c=v.dataset.region;v.classList.toggle("is-zone-hot",!!l&&c===l)})},s=l=>{!l||!q.includes(l)||(r(l),je(t,l,{onClose:()=>r(null)}))};n.forEach(l=>{l.addEventListener("pointerenter",()=>r(l.getAttribute("data-open-zone")||"")),l.addEventListener("pointerleave",v=>{const c=v.relatedTarget;c instanceof Node&&e.contains(c)&&c.closest("[data-open-zone]")||r(null)}),l.addEventListener("click",v=>{v.preventDefault();const c=l.getAttribute("data-open-zone");c&&(T(),s(c))})});const i=(d=(o=a==null?void 0:a.params)==null?void 0:o.get)==null?void 0:d.call(o,"zone");i&&q.includes(i)&&requestAnimationFrame(()=>s(i))}function Je(e){const t=e.querySelectorAll(".bb-section"),a=new IntersectionObserver(n=>{for(const r of n)r.isIntersecting&&(r.target.classList.add("is-visible"),a.unobserve(r.target))},{root:null,rootMargin:"0px 0px -8% 0px",threshold:.08});t.forEach(n=>a.observe(n))}function Xe(e){const t=e.querySelector("[data-neuro-score]");if(!t)return;const a=parseFloat(t.textContent||"0"),n=1200,r=performance.now(),s=i=>{const o=Math.min(1,(i-r)/n),d=1-(1-o)**3;t.textContent=(a*d).toFixed(1),o<1&&requestAnimationFrame(s)};requestAnimationFrame(s)}function Ze(e){const t=e.querySelectorAll("[data-bar-value]"),a=new IntersectionObserver(n=>{for(const r of n){if(!r.isIntersecting)continue;const s=r.target,i=parseFloat(s.getAttribute("data-bar-value")||"0"),o=s.querySelector(".pdf-bar-gradient");o&&(o.style.clipPath="inset(0 100% 0 0)",requestAnimationFrame(()=>{o.style.clipPath=`inset(0 ${Math.max(0,100-i).toFixed(2)}% 0 0)`})),a.unobserve(s)}},{threshold:.2});t.forEach(n=>a.observe(n))}function m(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Qe(){return{instruction:'<svg class="ex-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" aria-hidden="true"><path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/></svg>',research:'<svg class="ex-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" aria-hidden="true"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3M11 8v6M8 11h6"/></svg>',amplify:'<svg class="ex-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" aria-hidden="true"><path d="M12 3l1.8 5.5h5.7l-4.6 3.4 1.8 5.5-4.7-3.4-4.7 3.4 1.8-5.5-4.6-3.4h5.7L12 3z"/></svg>',results:'<svg class="ex-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" aria-hidden="true"><path d="M4 19V5M9 19v-6M14 19V9M19 19v-9"/><path d="M4 19h16" stroke-linecap="round"/></svg>'}}function V(e){return String(e||"").split(`
`).map(a=>`<p>${m(a)}</p>`).join("")}function Ke(e){e.querySelectorAll(".ex-acc").forEach(t=>{const a=t.querySelector(".ex-acc__trigger");a&&a.addEventListener("click",()=>{const r=!(t.getAttribute("data-open")==="true");t.setAttribute("data-open",String(r)),a.setAttribute("aria-expanded",String(r)),T()})})}function O(e){requestAnimationFrame(()=>{var t;(t=e.querySelector(".ex-lux"))==null||t.classList.add("is-visible")})}async function et(e,t,a,n){var h,E;const r=C(a.lang),s=Qe();e.className="bb-root bb-root--spa bb-root--exercise",e.innerHTML=`
    <div class="ex-lux">
    ...
    </div>`;const i=e.querySelector("#ex-back");if(i==null||i.addEventListener("click",()=>{T(),z("map")}),!Number.isFinite(n)||n<1){const u=e.querySelector(".ex-lux__scroll .ex-lux__inner");u&&(u.innerHTML=`<p class="ex-lux__err">${m(r.exerciseNotFound)}</p>`),O(e);return}if(!a.paid){e.querySelector(".ex-lux__scroll .ex-lux__inner").innerHTML=`
      ...
      </div>`,(h=e.querySelector("#ex-unlock"))==null||h.addEventListener("click",()=>{T(),a.tributeUrl?W(a.tributeUrl):z("premium")}),e.querySelector("#ex-cta").textContent=r.premiumCta,(E=e.querySelector("#ex-cta"))==null||E.addEventListener("click",()=>{T(),a.tributeUrl?W(a.tributeUrl):z("premium")}),O(e);return}let o;try{o=await Ie(t,n)}catch(u){const x=e.querySelector(".ex-lux__scroll .ex-lux__inner"),b=(u==null?void 0:u.status)===403?r.exercisePremiumTitle:(u==null?void 0:u.status)===404?r.exerciseNotFound:r.errorLoad;x&&(x.innerHTML=`<p class="ex-lux__err">${m(b)}</p>`),O(e);return}const d=Math.max(0,Math.min(4,(o.effectiveness||3)-1)),l=r.exerciseEfficiencyLabels[d]??"—",v=(o.regions||[]).map(u=>`<span class="ex-lux__pill">${m(r.regions[u]??u)}</span>`).join(""),c=(o.researchLinks||[]).map(u=>`<a class="ex-lux__link" href="${m(u.url)}" target="_blank" rel="noopener noreferrer">${m(u.label||u.url)}</a>`).join(""),f=o.instructionImageUrl?`<figure class="ex-lux__figure"><img src="${m(o.instructionImageUrl)}" alt="" loading="lazy" decoding="async" /></figure>`:"";e.querySelector(".ex-lux__scroll .ex-lux__inner").innerHTML=`
    <div class="ex-lux__hero">
    ...
    <div class="ex-lux__scroll-pad"></div>`,Ke(e);const g=e.querySelector("#ex-cta");g==null||g.addEventListener("click",()=>{var u,x,b;T(),(b=(x=(u=window.Telegram)==null?void 0:u.WebApp)==null?void 0:x.showAlert)==null||b.call(x,r.exerciseCtaMessage)}),O(e)}function j(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function tt(e,t){if(!e)return"—";try{return new Date(e).toLocaleString(t==="en"?"en-GB":"ru-RU",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return e}}async function nt(e,t,a){var l,v;const n=C(a.lang),r=J().params.get("zone"),s=document.createElement("section");s.className="bb-section is-visible bb-history",s.innerHTML=`
  ...
  `;const i=document.createElement("div");i.className="space-y-3",i.textContent=n.loading,s.appendChild(i),e.replaceChildren(s);let o;try{o=await Ne(t)}catch{i.innerHTML=`<p class="bb-error">${j(n.errorLoad)}</p>`;return}const d=o.items??[];if(i.replaceChildren(),!d.length){const c=document.createElement("div");c.className="glass rounded-2xl p-5 text-center";const f=document.createElement("p");f.className="text-slate-200 mb-4",f.textContent=n.historyEmpty;const g=document.createElement("button");g.type="button",g.className="bb-btn-primary",g.textContent=n.startTest,g.addEventListener("click",()=>z("test")),c.append(f,g),i.appendChild(c);return}for(const[c,f]of d.entries()){const g=document.createElement("article");g.className=`glass rounded-2xl p-4 bb-history-card${c===0?" is-active":""}`;const h=document.createElement("div");h.className="flex justify-between items-start gap-2 mb-2";const E=document.createElement("div");if(E.innerHTML=`
      <p class="text-xs text-cyan-200/80 uppercase tracking-wide">${j(tt(f.createdAt,a.lang))}</p>
    ...
    `,h.appendChild(E),c===0){const b=document.createElement("span");b.className="bb-badge",b.textContent=n.latest,h.appendChild(b)}g.appendChild(h);const u=document.createElement("div");u.className="bb-history-deltas";for(const b of q){const $=n.regions[b]??b,y=Number(((l=f.scores)==null?void 0:l[b])??0).toFixed(1),k=f.isFirst?"—":((v=f.deltas)==null?void 0:v[b])??"·",p=document.createElement("div");p.className=`bb-history-row${r===b?" bb-history-row--focus":""}`;const M=document.createElement("span");M.textContent=$;const N=document.createElement("span");N.textContent=`${y}%`;const I=document.createElement("span");I.textContent=k,typeof k=="string"&&k.includes("↑")&&(I.className="bb-delta-up"),typeof k=="string"&&k.includes("↓")&&(I.className="bb-delta-down"),p.append(M,N,I),u.appendChild(p)}g.appendChild(u);const x=document.createElement("button");x.type="button",x.className="bb-btn-ghost mt-3 w-full",x.textContent=n.openThisMap,x.addEventListener("click",()=>z("map")),g.appendChild(x),i.appendChild(g)}r&&d.length&&requestAnimationFrame(()=>{var c;(c=s.querySelector(".bb-history-row--focus"))==null||c.scrollIntoView({block:"center",behavior:"smooth"})})}function F(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function at(e,t){var n;const a=C(t.lang);e.innerHTML=`
  ...
  `,(n=e.querySelector("#bb-premium-buy"))==null||n.addEventListener("click",()=>{T(),t.tributeUrl&&W(t.tributeUrl)})}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}async function rt(e,t,a,{onProfile:n}={}){const r=C(a.lang),s={variant:a.testVariant||"development",questions:[],answers:{},step:0},i=document.createElement("section");i.className="bb-section is-visible bb-test",e.replaceChildren(i);async function o(){i.innerHTML=`<p class="text-cyan-200/80 text-sm">${S(r.loading)}</p>`;try{const c=await He(t,s.variant);s.questions=c.questions??[],s.step=0,s.answers={},l()}catch{i.innerHTML=`<p class="bb-error">${S(r.errorLoad)}</p>`}}function d(){i.innerHTML=`
    ...
    `;const h=i.querySelector("#bb-test-options");for(const E of c.options??[]){const u=document.createElement("button");u.type="button",u.className="bb-test-option",u.innerHTML=`<span class="bb-test-option-key">${S(E.key)}</span><span>${S(E.label)}</span>`,u.addEventListener("click",()=>v(E.key)),h.appendChild(u)}}async function v(c){T();const f=s.questions[s.step];if(s.answers[f.id]=c,s.step+1<s.questions.length){s.step+=1,l();return}i.innerHTML=`
      <div class="bb-loading">
        <div class="bb-loading__pulse"></div>
        <p class="text-sm text-cyan-200/80">${S(r.computing)}</p>
      </div>`;try{const g={};for(const[E,u]of Object.entries(s.answers))g[String(E)]=u;const h=await qe(t,{variant:s.variant,answers:g});n&&n(h),z("map")}catch{i.innerHTML=`<p class="bb-error">${S(r.errorLoad)}</p>`}}d()}let _=null,A=null,U=null;function ce(){U&&(U(),U=null)}function st(){ce();const e=document.getElementById("bb-header");if(!e)return;const t=()=>{const a=window.scrollY||document.documentElement.scrollTop||0;e.classList.toggle("bb-header--scroll-hidden",a>56)};window.addEventListener("scroll",t,{passive:!0}),t(),U=()=>{window.removeEventListener("scroll",t),e.classList.remove("bb-header--scroll-hidden")}}function de(e){const t=document.getElementById("bb-header");if(!t)return;if(e==="map"&&!document.body.classList.contains("bb-app--needs-bot")){t.hidden=!1;const n=document.getElementById("bb-header-wordmark");n&&(n.textContent="brainboosty"),st()}else t.hidden=!0,ce()}function it(e){var s;document.body.classList.add("bb-app--needs-bot"),de(""),(s=document.querySelector(".bb-premium-fab"))==null||s.remove();const t=document.getElementById("bb-nav");t&&(t.hidden=!0,t.innerHTML="");const a=C(_.lang);e.className="bb-root bb-root--spa bb-root--bot-gate",e.replaceChildren();const n=document.createElement("div");n.className="bb-bot-gate",n.setAttribute("role","status");const r=document.createElement("p");r.className="bb-bot-gate__line",r.textContent=a.notRegistered,n.appendChild(r),e.appendChild(n)}async function ot(e){var a;if(A)return document.body.classList.remove("bb-app--needs-bot"),!0;const t=C(_.lang);e.className="bb-root bb-root--spa",e.innerHTML=`
      <div class="bb-loading">
        <div class="bb-loading__pulse"></div>
        <p class="text-sm text-cyan-200/80">${t.loading}</p>
      </div>`;try{return A=await Me(_),document.body.classList.remove("bb-app--needs-bot"),ue(A),(a=_.user)!=null&&a.first_name&&!A.userDisplayName&&(A.userDisplayName=[_.user.first_name,_.user.last_name].filter(Boolean).join(" ")),!0}catch(n){if((n==null?void 0:n.status)===401&&(n==null?void 0:n.detail)==="invalid_site_token"&&(_!=null&&_.siteToken)){try{localStorage.removeItem(R),localStorage.removeItem(D)}catch{}return window.location.replace("/"),!1}if((n==null?void 0:n.status)===403&&(n==null?void 0:n.detail)==="not_registered")return it(e),!1;const r=(n==null?void 0:n.status)===403?t.notRegistered:(n==null?void 0:n.status)===401?t.authError:t.errorLoad;return e.className="bb-root bb-root--spa",e.innerHTML=`<p class="bb-error">${r}</p>`,!1}}function lt(e){const t=document.getElementById("bb-nav");t&&t.querySelectorAll(".bb-nav__btn[data-route]").forEach(a=>{a.classList.toggle("is-active",a.dataset.route===e)})}function ct(e){if(!_)return;const t=e==="en"?"en":"ru";_.lang!==t&&(_.lang=t,document.documentElement.lang=t,be(t))}function ue(e){e!=null&&e.lang&&ct(e.lang)}function dt(e){var n;if((n=document.querySelector(".bb-premium-fab"))==null||n.remove(),e.paid||!e.tributeUrl)return;const t=C((_==null?void 0:_.lang)||e.lang),a=document.createElement("button");a.type="button",a.className="bb-premium-fab",a.textContent=t.premiumCta,a.addEventListener("click",()=>{T(),z("premium")}),document.body.appendChild(a)}function be(e){var r;const t=document.getElementById("bb-nav");if(!t)return;const a=C(e);t.hidden=!1;const n=_!=null&&_.siteToken?`<button type="button" class="bb-nav__btn bb-nav__btn--logout" data-site-logout>${a.navLogout}</button>`:"";t.innerHTML=`
    ...
    ${n}
  `,t.querySelectorAll(".bb-nav__btn[data-route]").forEach(s=>{s.addEventListener("click",()=>{T(),z(s.dataset.route||"map")})}),(r=t.querySelector("[data-site-logout]"))==null||r.addEventListener("click",()=>{T();try{localStorage.removeItem(R),localStorage.removeItem(D)}catch{}window.location.replace("/")})}async function Q(e){var r;const t=document.getElementById("bb-root");if(!t||!_)return;de(e.name);const a=document.getElementById("bb-nav"),n=e.name==="exercise";if(document.body.classList.toggle("bb-route-exercise",n),n||lt(e.name),e.name!=="map"&&((r=document.querySelector(".bb-premium-fab"))==null||r.remove()),!!await ot(t)){if(be(_.lang),a&&(a.hidden=n),e.name==="premium"){at(t,A);return}if(e.name==="test"){await rt(t,_,A,{onProfile:s=>{A=s,ue(s)}});return}if(e.name==="history"){await nt(t,_,A);return}if(e.name==="exercise"){const s=parseInt(e.params.get("id")||"0",10);await et(t,_,A,s);return}if(!A.hasMap&&e.name==="map"){z("test");return}Ve(t,A,e),dt(A)}}async function K(e){const t=e.lang==="en"?"en":"ru";_={initData:e.initData??"",user:e.user??null,lang:t,siteToken:e.siteToken??""},A=null,document.body.classList.add("bb-app--telegram"),_.siteToken&&document.body.classList.add("bb-app--site");const a=document.getElementById("bb-root");if(!a)return;a.classList.add("bb-root--spa"),Fe(r=>{Q(r).catch(()=>{})}),Re();const n=J();window.location.hash?await Q(n):z("map")}const ee="/assets/full-glowing-brain-Cl127Rfm.png",te=.088,ne=15,ae=2,re=.4;function G(e,t,a){return Math.max(t,Math.min(a,e))}function ut(){var e,t;return((t=(e=window.matchMedia)==null?void 0:e.call(window,"(prefers-reduced-motion: reduce)"))==null?void 0:t.matches)??!1}function bt(e,t,a){const n=e.getBoundingClientRect(),r=80,s=Math.max(n.width+r*2,1),i=Math.max(n.height+r*2,1),o=n.left+n.width/2,d=n.top+n.height/2;return{nx:G((t-o)/(s*.5),-1,1),ny:G((a-d)/(i*.5),-1,1)}}function pt(e){var b,$;if(ut())return()=>{};const t=e.querySelector("[data-parallax-brain]"),a=e.querySelector("[data-parallax-glow]");if(!t)return()=>{};let n={nx:0,ny:0},r=!1,s={nx:0,ny:0},i=!1,o=0,d=0,l=0;const v=(($=(b=window.matchMedia)==null?void 0:b.call(window,"(pointer: coarse)"))==null?void 0:$.matches)??!1,c=()=>r?{tx:n.nx,ty:n.ny}:i?{tx:s.nx*.62,ty:s.ny*.62}:{tx:0,ty:0},f=()=>{l=0;const{tx:y,ty:k}=c();o+=(y-o)*te,d+=(k-d)*te;const p=o*ne,M=d*ne,N=d*-ae,I=o*ae;if(t.style.transform=`translate3d(${p}px, ${M}px, 0) rotateX(${N}deg) rotateY(${I}deg)`,a){const _e=-p*re,ve=-M*re;a.style.transform=`translate3d(calc(-50% + ${_e}px), calc(-50% + ${ve}px), 0) scale(1.06)`}const{tx:ge,ty:me}=c(),he=Math.abs(o-ge)>.003||Math.abs(d-me)>.003,fe=Math.abs(o)>.004||Math.abs(d)>.004;(he||fe||i)&&(l=requestAnimationFrame(f))},g=()=>{l||(l=requestAnimationFrame(f))},h=y=>{if(!y.isTrusted)return;const{nx:k,ny:p}=bt(e,y.clientX,y.clientY);n={nx:k,ny:p},r=!0,g()},E=()=>{r=!0},u=()=>{r=!1,g()};e.addEventListener("pointermove",h,{passive:!0}),e.addEventListener("pointerenter",E),e.addEventListener("pointerleave",u),e.addEventListener("pointerdown",()=>{v&&typeof(DeviceOrientationEvent==null?void 0:DeviceOrientationEvent.requestPermission)=="function"&&DeviceOrientationEvent.requestPermission().then(y=>{y==="granted"&&(i=!0)}).catch(()=>{})},{passive:!0});let x=null;return window.DeviceOrientationEvent&&(x=y=>{if(y.gamma==null||y.beta==null)return;const k=G(y.gamma/32,-1,1),p=G((y.beta-44)/36,-1,1);s={nx:k,ny:p},i=!0,g()},window.addEventListener("deviceorientation",x,!0)),t.style.willChange="transform",a&&(a.style.willChange="transform"),g(),()=>{e.removeEventListener("pointermove",h),e.removeEventListener("pointerenter",E),e.removeEventListener("pointerleave",u),x&&window.removeEventListener("deviceorientation",x,!0),l&&cancelAnimationFrame(l),t.style.willChange="",t.style.transform="",a&&(a.style.willChange="",a.style.transform="")}}const gt={root:null,rootMargin:"0px 0px -10% 0px",threshold:.08};function mt(e,{reducedMotion:t}){if(t)return e.querySelectorAll(".bb-landing-reveal").forEach(r=>r.classList.add("is-in-view")),()=>{};const a=e.querySelectorAll(".bb-landing-reveal");if(!a.length)return()=>{};const n=new IntersectionObserver(r=>{for(const s of r)s.isIntersecting&&(s.target.classList.add("is-in-view"),n.unobserve(s.target))},gt);return a.forEach(r=>n.observe(r)),()=>{n.disconnect()}}function w(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const pe="bb-landing-lang",ht={not_registered:"landingHubErrorNotRegistered",oidc_not_configured:"landingHubErrorNotConfigured",token_exchange_failed:"landingHubErrorOidc",invalid_state:"landingHubErrorOidc",state_expired:"landingHubErrorOidc",missing_code:"landingHubErrorOidc"};function ft(){try{const e=localStorage.getItem(pe);if(e==="en"||e==="ru")return e}catch{}return null}function _t(e,t){const a=ht[t];return a&&e[a]?e[a]:e.landingHubErrorOidc}function vt(){const e=(window.location.hash||"").replace(/^#/,"");if(!e.startsWith("hub-login"))return null;const t=e.includes("?")?e.slice(e.indexOf("?")+1):"";return new URLSearchParams(t).get("error")}function xt(e){document.body.classList.add("bb-lang-gate-open");const t=document.createElement("div");t.className="bb-lang-gate",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-labelledby","bb-lang-gate-title"),t.innerHTML=`
      ...
      <header id="top" class="bb-landing-hero">
        <div class="bb-landing-hero__visual-anchor">
          ...
          <div class="bb-landing-hero__brain-layer" data-parallax-brain>
            <img class="bb-landing-hero__brain" src="${ee}" alt="" width="280" height="280" decoding="async" />
          </div>
        </div>
      ...
      <section id="about" class="bb-landing-section bb-landing-reveal">
        ...
        <article class="bb-landing-about glass bb-landing-hover-rise">
          <div class="bb-landing-about__photo-wrap">
            <img class="bb-landing-about__photo" src="${r}" alt="" width="320" height="320" loading="lazy" data-fallback-src="${ee}" />
  ...
  `,a.querySelectorAll(".bb-landing-about__photo").forEach(b=>{const $=b.getAttribute("data-fallback-src");$&&b.addEventListener("error",()=>{b.removeAttribute("data-fallback-src"),b.src=$})}),a.querySelectorAll('a[href^="#"]').forEach(b=>{b.addEventListener("click",$=>{var p;const y=(p=b.getAttribute("href"))==null?void 0:p.slice(1);if(!y)return;const k=document.getElementById(y);k&&($.preventDefault(),k.scrollIntoView({behavior:"smooth",block:"start"}))})});const d=a.querySelector(".bb-landing"),l=mt(d||a,{reducedMotion:i}),v=a.querySelector(".bb-landing-hero"),c=v?pt(v):()=>{},f=()=>{l(),c(),window.removeEventListener("pagehide",f)};window.addEventListener("pagehide",f);const g=a.querySelectorAll("[data-start-site-login]"),h=a.querySelector(".bb-landing-hub__status"),E=b=>{if(!h||(h.hidden=!b,h.replaceChildren(),!b))return;const $=document.createElement("p");$.className="bb-landing-hub__status-line",$.textContent=b,h.appendChild($)};g.forEach(b=>{b.addEventListener("click",()=>{var y;const $=C(e);if((y=document.getElementById("hub-login"))==null||y.scrollIntoView({behavior:"smooth",block:"start"}),!n.oidcConfigured){E($.landingHubErrorNotConfigured);return}window.location.href=o})});const u=vt();u&&((x=document.getElementById("hub-login"))==null||x.scrollIntoView({behavior:"smooth",block:"start"}),E(_t(t,u)),window.location.hash="hub-login")}function wt(){try{const e=navigator.userAgent||"";if(/Telegram/i.test(e))return!0;const t=`${window.location.hash||""}${window.location.search||""}`;if(/tgWebAppPlatform|tgWebAppData|tgWebAppVersion/i.test(t))return!0}catch{}return!1}function Et(){var e;return(e=window.Telegram)!=null&&e.WebApp?Promise.resolve():new Promise(t=>{const a=document.createElement("script");a.src="https://telegram.org/js/telegram-web-app.js",a.async=!0,a.onload=()=>t(),a.onerror=()=>t(),document.head.appendChild(a)})}function Lt(){var a;const e=(a=window.Telegram)==null?void 0:a.WebApp;return e?(e.initData||"").trim().length>0:!1}function $t(){var e;try{return((e=localStorage.getItem(R))==null?void 0:e.trim())||""}catch{return""}}async function Tt(){var a,n,r,s,i;const t=(a=new URLSearchParams(window.location.search).get("oidc_handoff"))==null?void 0:a.trim();if(!t)return!1;try{const o=await fetch(`/api/webapp/auth/oidc/handoff?oidc_handoff=${encodeURIComponent(t)}`,{cache:"no-store"});if(!o.ok)return!1;const d=await o.json(),l=(n=d==null?void 0:d.accessToken)==null?void 0:n.trim();if(!l)return!1;const v=d.lang==="en"?"en":"ru";localStorage.setItem(R,l),localStorage.setItem(D,JSON.stringify({first_name:((r=d.user)==null?void 0:r.first_name)??"",last_name:((s=d.user)==null?void 0:s.last_name)??"",language_code:((i=d.user)==null?void 0:i.language_code)==="en"?"en":v}));const c=window.location.pathname||"/";return window.history.replaceState(null,"",c),window.location.hash="map",window.location.reload(),!0}catch{return!1}}function kt(){var s;const e=(window.location.hash||"").replace(/^#/,"");if(!e.startsWith("auth/callback"))return!1;const t=e.includes("?")?e.slice(e.indexOf("?")+1):"",a=new URLSearchParams(t),n=(s=a.get("access_token"))==null?void 0:s.trim();if(!n)return!1;const r=a.get("lang")==="en"?"en":"ru";try{localStorage.setItem(R,n),localStorage.setItem(D,JSON.stringify({first_name:a.get("first_name")||"",last_name:"",language_code:r}))}catch{return!1}return window.location.replace("/#map"),!0}function St(){try{const e=localStorage.getItem(D);return e?JSON.parse(e):null}catch{return null}}async function At(){var n,r;if(await Tt()||kt())return;wt()&&await Et();const{initData:e,user:t,lang:a}=De();if(Lt())K({initData:e,user:t,lang:a,siteToken:""});else{const s=$t();if(s){const i=St(),o=(i==null?void 0:i.language_code)==="en"||(r=(n=i==null?void 0:i.language_code)==null?void 0:n.startsWith)!=null&&r.call(n,"en")||a==="en"?"en":"ru";K({initData:"",user:i?{first_name:i.first_name,last_name:i.last_name,language_code:i.language_code}:null,lang:o,siteToken:s})}else yt()}}At().catch(()=>{});
